    ...
    <body>
        ...
        <article>
            ...
            <table class="balance">
                ...
                <tr>
                    <th><span contenteditable>Discount   <?php echo $discount?>%</span></th>
                    
                    <td><span data-prefix></span><span>BDT  <?php echo $total_tk=$this->cart->total()* $discount/100; ?></span></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><span data-prefix></span><span>BDT <?php echo $total=$this->cart->total() - $total_tk; ?></span></td>
                </tr>
            </table>
        </article>
        <aside>
